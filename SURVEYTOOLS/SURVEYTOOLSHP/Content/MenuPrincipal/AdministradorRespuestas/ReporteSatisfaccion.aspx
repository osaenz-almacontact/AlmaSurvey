<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.Master" AutoEventWireup="true" CodeBehind="ReporteSatisfaccion.aspx.cs" Inherits="SURVEYTOOLSHP.Content.MenuPrincipal.AdministradorRespuestas.ReporteSatisfaccion" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content_body" runat="server">
    ...
    <div class="container-fluid">
        <p style="text-align: left;" class="css_color_titulo css_tamaño_titulo_central">
            <strong>
                <label>Reporte Satisfacción</label>
            </strong>
        </p>
        <hr />
        <div class="form-row">
                        ...
                        <table style="width: 100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td  padding: 8px; text-align: center">
                                    ...
                                    <asp:GridView ID="dgrid_reporte_satisfaccion" runat="server" CssClass="table table-bordered"
                                        EmptyDataText="NO FOUND" AllowPaging="True"
                                        CellPadding="4"  PageSize="20"
                                        OnPageIndexChanging="dgrid_reporte_satisfaccion_PageIndexChanging">
                                        <Columns>
